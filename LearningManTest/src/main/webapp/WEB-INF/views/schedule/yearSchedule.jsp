        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input class='filter' type="checkbox" value="정연" checked><label class="checkbox-inline">정연</label>
                        <input class='filter' type="checkbox" value="다현" checked><label class="checkbox-inline">다현</label>
                        <input class='filter' type="checkbox" value="사나" checked><label class="checkbox-inline">사나</label>
                        <input class='filter' type="checkbox" value="나연" checked><label class="checkbox-inline">나연</label>
                        <input class='filter' type="checkbox" value="지효" checked><label class="checkbox-inline">지효</label>
                    </div>
                </div>
