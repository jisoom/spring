...
<div id="aside">
    ...
    <!-- Sidebar -->
    <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 911px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
<!-- 사용자 로그인 영역 시작-->
      <!-- 로그인 되었다면.. -->
      <c:if test="${sessionScope.empNum != null}"> 
	      <form name="frmOut" id="frmOut" method="post" action="/emp/logout">
		      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
		      	<div class="image">
		        	<img src="/resources/adminlte/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
		        </div>
		        <div class="info">
		        	<a href="#" class="d-block">${sessionScope.nm}님 <br/>환영합니다.</a>
		        </div>
		        <div class="image">
			  		<input type="image" src="/resources/images/logout.png" style="width: 30px; background-color: #FFF;cursor: pointer;border: 0"
      ...
      <c:if test="${sessionScope.empNum == null}"> 
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      	<form name="frm" id="frm" class="form-horizontal" method="post" action="/emp/login">
      		<table border="0" style="width: 100%;">
      			<tr>
      				<td>
                    	<input type="text" name="empNum" class="form-control" id="empNum" placeholder="아이디" />
      				</td>
      				<td rowspan="2">
      					<button type="button" id="btnLogin" class="btn btn-info" style="height: 80px;" >로그인</button>
      				</td>
      			</tr>
      			<tr>
      				<td>
...
<!-- 사용자 로그인 영역 끝-->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/emp/list" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>직원관리</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/cus/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>고객관리</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/repSer/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>수리서비스관리</p>
                </a>
              </li>
      ...
      <!-- /.sidebar-menu -->
    </div></div></div><div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden"><div class="os-scrollbar-track"><div class="os-scrollbar-handle" style="width: 100%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden"><div class="os-scrollbar-track"><div class="os-scrollbar-handle" style="height: 67.2071%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar-corner"></div></div>
    <!-- /.sidebar -->
  </aside>
</div>