...
public class SiteMatController {
	...
	public String list(Model model) {
		...
		//사업장 자재 목록의 검색 조건으로 사업장 명과 자재명을 일단 빈 값으로 처리 => 모든 자재 목록 가져옴
		//(쿼리에 map 필요없는데 이미 넣어줘서 임의로 만듦)
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("siteNm", "");
		map.put("itemNm", "");
		
		//사업장 자재 목록(사업장명, 자재명 포함)
		//{siteNum=2021001, matNmCd=MAT001, cnt=15, 
		//purDt=2021/08/03, siteNm=대전 사업장, itemNm=CCTV, purPri=10000000}
